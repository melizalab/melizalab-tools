...
def kernel(name, bandwidth, dt):
    """
    Computes the values of a kernel function with given width.
    ...
    bandwidth: the (inverse) bandwidth of the kernel, in units of dt
    ...
    N = floor(D/dt)               # number of grid points in half the support
    G = (arange(1, 2*N+2)-1-N)*dt # grid support
    xv =  G/bandwidth
